...
static const int bbr_cwnd_gain  = BBR_UNIT * 2.5;
/* The pacing_gain values for the PROBE_BW gain cycle, to discover/share bw: */
static const int bbr_pacing_gain[] = {
	BBR_UNIT * 150 / 100,	/* UP: probe for more available bw */
...
MODULE_DESCRIPTION("TCP BBR 240710-2(Bottleneck Bandwidth and RTT)");
